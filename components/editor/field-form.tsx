...
export function FieldForm({
  ...
  const handleSave = () => {
    ...
    onSave({
      ...
      selection_type: fieldType === "multiselect" ? selectionType : undefined,
    })
  }
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4 py-4">
          ...
          {/* Тип выбора - только для multiselect (список) */}
          ...
          {needsOptions && (
            <div className="space-y-2">
              ...
              {/* Dropdown (select): компактные строки без картинок */}
              {fieldType === "select" && (
                <>
              ...
              {/* List (multiselect): карточки с картинками */}
              {fieldType === "multiselect" && (
